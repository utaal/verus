...
use crate::ast::{
    ...
    DatatypeX, Expr, ExprX, FunX, Field, Function, FunctionX, GenericBound, GenericBoundX, Ident, Idents,
...
fn simplify_one_expr(
    ...
    match &expr.x {
        ExprX::Call(CallTarget::FnSpec { typ_param, fun }, args) => {
            ...
            let call = ExprX::Call(CallTarget::Static(Arc::new(FunX { path, trait_path: None }), Arc::new(typ_args)), Arc::new(expr_args));
        ...
        ExprX::Closure { params, body, closure_impl } => {
            ...
            let target = CallTarget::Static(Arc::new(FunX { path: path.clone(), trait_path: None }), Arc::new(typ_args));
            ...
            let target = CallTarget::Static(Arc::new(FunX { path: apply, trait_path: None }), Arc::new(targs));
